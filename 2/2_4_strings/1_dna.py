...
#
# Например, в строке "acggtgttat" процентное содержание символов G и C равно 410⋅100=40.0, где 4 --
...
dna = str(input().lower())
print((dna.count('c') + dna.count('g')) / len(dna) * 100)
# По-хорошему надо было бы еще использовать round()
