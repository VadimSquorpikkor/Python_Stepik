...
dictionary_to_encode = {}  # create dictionary
dictionary_to_decode = {}  # create dictionary

for i in range(len(s1)):
    dictionary_to_encode[s1[i]] = s2[i]
    dictionary_to_decode[s2[i]] = s1[i]

for i in s3_to_code:  # make the string crypted
    s5_out_coded += dictionary_to_encode[i]
print(s5_out_coded)

for i in s4_to_uncode:  # make the string uncrypted
    s6_out_decoded += dictionary_to_decode[i]
print(s6_out_decoded)
